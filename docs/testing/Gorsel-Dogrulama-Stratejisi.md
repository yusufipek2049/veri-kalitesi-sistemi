...
[Görsel Tasarım Sistemi](../design/frontend/Gorsel-Tasarim-Sistemi.md). İlk ekran sözleşmesi:
[Dashboard Ekran Sözleşmesi](../design/frontend/03-Dashboard/Dashboard-Ekran-Sozlesmesi.md).
İlk referans: [reference-dashboard.png](../design/frontend/references/reference-dashboard.png).
