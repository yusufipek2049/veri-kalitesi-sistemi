...
- Politika: `28C-v1`
- Test: `tests/unit/test_secure_sdlc_sast.py`
...
python3 -m ruff format --check src/veri_kalitesi/secure_sdlc tests/unit/test_secure_sdlc.py tests/unit/test_secure_sdlc_sbom.py tests/unit/test_secure_sdlc_sast.py
python3 -m mypy src/veri_kalitesi/secure_sdlc tests/unit/test_secure_sdlc.py tests/unit/test_secure_sdlc_sbom.py tests/unit/test_secure_sdlc_sast.py
