...
```bash
python3 -m pytest -q tests/unit/test_secure_sdlc_vulnerabilities.py
python3 -m pytest -q
python3 -m ruff check .
python3 -m compileall -q docs/backend/src docs/testing/01-Birim
python3 -m mypy src/veri_kalitesi/secure_sdlc/vulnerabilities.py tests/unit/test_secure_sdlc_vulnerabilities.py
