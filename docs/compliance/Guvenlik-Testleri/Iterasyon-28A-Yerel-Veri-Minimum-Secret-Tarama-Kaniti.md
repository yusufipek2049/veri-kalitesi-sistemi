...
- Politika: `28A-v1`
- Test: `tests/unit/test_secure_sdlc.py`
...
python3 -m ruff format --check src/veri_kalitesi/secure_sdlc tests/unit/test_secure_sdlc.py
python3 -m mypy src/veri_kalitesi/secure_sdlc tests/unit/test_secure_sdlc.py
