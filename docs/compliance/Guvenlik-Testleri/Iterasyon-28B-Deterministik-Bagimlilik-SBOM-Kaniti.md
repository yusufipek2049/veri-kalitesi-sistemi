...
- Proje sürümü: `0.1.0`
- SBOM: `docs/compliance/Surum-Paketleri/Iterasyon-28B-SBOM.cdx.json`
- SHA-256: `b97b67b2a8bc8f9ec574f0ab953710325399aa3ed7dae7434212f83d8ea209d3`
- Test: `tests/unit/test_secure_sdlc_sbom.py`
...
python3 -m ruff format --check src/veri_kalitesi/secure_sdlc tests/unit/test_secure_sdlc.py tests/unit/test_secure_sdlc_sbom.py
python3 -m mypy src/veri_kalitesi/secure_sdlc tests/unit/test_secure_sdlc.py tests/unit/test_secure_sdlc_sbom.py
