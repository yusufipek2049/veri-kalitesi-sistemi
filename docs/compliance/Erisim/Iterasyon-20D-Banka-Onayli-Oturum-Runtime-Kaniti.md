...
- Komut: `PYTHONPATH=docs/backend/src python3 -m pytest -q`
- Gerçekleşen: 993 test geçti; kimlik hedef grubu 47 testle geçti.
- `PYTHONPATH=docs/backend/src python3 -m mypy .`: PASS, 146 kaynak dosya.
- `python3 -m ruff check .`: PASS.
- `python3 -m ruff format --check .`: PASS, 146 dosya.
- `PYTHONPATH=docs/backend/src python3 -m compileall -q docs/backend/src`: PASS.
- `PYTHONPATH=docs/backend/src python3 -m veri_kalitesi.secure_sdlc .`: CLEAN,
