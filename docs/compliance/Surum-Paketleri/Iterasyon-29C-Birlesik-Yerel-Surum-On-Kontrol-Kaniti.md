...
```bash
pytest -q tests/unit/test_secure_sdlc_preflight.py
pytest -q
ruff check .
ruff format --check src/veri_kalitesi/secure_sdlc/preflight.py src/veri_kalitesi/secure_sdlc/sbom.py src/veri_kalitesi/secure_sdlc/models.py src/veri_kalitesi/secure_sdlc/errors.py tests/unit/test_secure_sdlc_preflight.py
mypy src/veri_kalitesi/secure_sdlc/preflight.py src/veri_kalitesi/secure_sdlc/sbom.py src/veri_kalitesi/secure_sdlc/models.py src/veri_kalitesi/secure_sdlc/errors.py tests/unit/test_secure_sdlc_preflight.py
python3 -m compileall -q docs/backend/src tests
PYTHONPATH=docs/backend/src python3 -m veri_kalitesi.secure_sdlc .
cmp -s <(PYTHONPATH=docs/backend/src python3 -m veri_kalitesi.secure_sdlc.sbom pyproject.toml) docs/compliance/Surum-Paketleri/Iterasyon-28B-SBOM.cdx.json
