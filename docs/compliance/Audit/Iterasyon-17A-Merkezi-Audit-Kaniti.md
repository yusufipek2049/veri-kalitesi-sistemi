...
- `python3 -m ruff format --check src/veri_kalitesi/audit src/veri_kalitesi/identity tests/unit/test_audit.py tests/unit/test_dashboard.py`: PASS
- `python3 -m ruff check docs/backend/src tests`: PASS
- `python3 -m compileall -q docs/backend/src tests`: PASS
