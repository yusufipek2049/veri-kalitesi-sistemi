...
- Komut: `PYTHONPATH=docs/backend/src pytest -q`
...
- `ruff check docs/backend/src tests`: PASS
- `ruff format --check src/veri_kalitesi/issues tests/unit/test_issues.py`: PASS
