...
[Backend Modül Haritası](../backend/)). Bu karar runtime
...
[Görsel Tasarım Sistemi](../design/frontend/Gorsel-Tasarim-Sistemi.md) içindedir. Bu karar
...
Ayrıntılar: [Alınan Kararlar](../memory/Alinan-Kararlar.md) ve [Açık Konular](../srs/15-Acik-Konular.md).
