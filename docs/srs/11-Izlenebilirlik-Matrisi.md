...
[Kanıta Dayalı Karar Sistemi](../architecture/Kanita-Dayali-Karar-Sistemi.md),
...
Kanonik hedef tasarım
`docs/architecture/Sentetik-Veri-ve-Gizlilik-Stratejisi.md`, mimari karar `ADR-016` ve
