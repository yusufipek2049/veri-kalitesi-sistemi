...
Bağlayıcı kaynaklar: [DQ-SCR skorlama kararları](../srs/04-Fonksiyonel-Gereksinimler/04.06-Skorlama.md)
ve [kanonik skorlama ve ölçüm yeterliliği tasarımı](../architecture/Veri-Kalitesi-Skorlama-ve-Olcum-Yeterliligi.md).
...
[Sentetik Veri ve Gizlilik Stratejisi](../architecture/Sentetik-Veri-ve-Gizlilik-Stratejisi.md).
...
- [Amaç ve Kapsam](../srs/01-Amac-ve-Kapsam.md)
- [Genel Sistem Açıklaması](../srs/02-Sistem-Aciklamasi.md)
- [MVP](../srs/12-MVP.md)
- [Açık Konular](../srs/15-Acik-Konular.md)
- [Sentetik Veri ve Gizlilik Stratejisi](../architecture/Sentetik-Veri-ve-Gizlilik-Stratejisi.md)
- [Frontend Görsel Tasarım Sistemi](../design/frontend/Gorsel-Tasarim-Sistemi.md)
- [Dashboard Ekran Sözleşmesi](../design/frontend/03-Dashboard/Dashboard-Ekran-Sozlesmesi.md)
