...
| --- | --- | --- |
| Sistem kurum içi veri merkezinde çalışır. | Kesin | [ADR-001](../architecture/Mimari-Kararlar.md) |
| Kaynak sistem erişimleri salt okunurdur; üretim kaynak verisi değiştirilmez. | Kesin | [ADR-002](../architecture/Mimari-Kararlar.md) |
| Kimlik kurumsal IdP/SSO ve LDAP arka ucu üzerinden; rol/scope güvenilir bağlamdan çözülür. | Kesin yön | [ADR-007](../architecture/Mimari-Kararlar.md) |
| Secret açık metin saklanmaz; yalnız kurumsal secret manager/PAM referansı tutulur. | Kesin yön | [ADR-006](../architecture/Mimari-Kararlar.md) |
| Sistem içi bildirim zorunludur; ServiceNow çekirdek issue yaşam döngüsünden ayrılmış adaptördür. | Kesin | [ADR-008](../architecture/Mimari-Kararlar.md) |
| Teknik hata, veri kalitesi ihlali, skor, yeterlilik ve kullanım kararı birbirine eritilmez. | Kesin | [ADR-015](../architecture/Mimari-Kararlar.md) |
| Uygulama kalıcılığı PostgreSQL-only hedefindedir; üretimde SQLite fallback yoktur. | Kesin | [ADR-020](../architecture/Mimari-Kararlar.md) |
| Değişken üretim değerleri sürümlü/onaylı politikadan çözülür; kayıt yoksa fail-closed davranılır. | Kesin | [ADR-018](../architecture/Mimari-Kararlar.md) |
...
| Mimari özet | `ADR-001–ADR-020` | [Mimari Kararlar](../architecture/Mimari-Kararlar.md) |
