...
Bu belge temel teknik yönleri, değişken politika yaklaşımını ve `OPEN-001–OPEN-018` karar paketini kanonik olarak toplar. Mimari özet için `docs/architecture/Mimari-Kararlar.md` kullanılır.
