...
| Ajan sözleşmesi | Ajan talimatnamesine deterministik görev seçim algoritması, boş "devam"/açık görev sözleşmesi ve `.agent-handoff`/commit-hash yasakları eklendi. |
...
[doğrulama bekleyen kayıt](archive/iterations/36/Iterasyon-36B5-Kapatma-ve-Yeniden-Acma.md)
oluşturuldu.
...
- `README.md`, ajan talimatnamesi, `DOCUMENTATION_INDEX.md`
