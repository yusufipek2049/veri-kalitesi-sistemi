...
- 00-Proje-Hafizasi/ "Sonraki adım" document (the single selected next task)
- 00-Proje-Hafizasi/ backlog document (Sonraki-Adimlar.md)
- 00-Proje-Hafizasi/Mevcut-Durum.md
- 00-Proje-Hafizasi/Alinan-Kararlar.md and Acik-Konular.md
- 01-SRS/SRS-INDEX.md and referenced requirements
