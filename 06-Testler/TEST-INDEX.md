...
- `secure_sdlc` hedef grubu; gerçek pozitif/yanlış pozitif, binary/büyük/dışlanan
  ...
  CycloneDX 1.5 çıktısı, veri-minimum SAST bulgu/sürüm kapısı ve doğrudan bağımlılık
  zafiyet sürüm kapısı için toplam 95 sentetik vaka içerir.
