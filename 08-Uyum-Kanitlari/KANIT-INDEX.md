...
- [İterasyon 17C1 - Transactional Outbox Kanıtı](Audit/Iterasyon-17C1-Transactional-Outbox-Kaniti.md) - `TechnicallyVerified`
- [İterasyon 17C2 - Kalan Yazımlar Outbox Kanıtı](Audit/Iterasyon-17C2-Kalan-Yazimlar-Outbox-Kaniti.md) - `TechnicallyVerified`
- [İterasyon 17D1 - Zamanlama Audit Geçiş Kanıtı](Audit/Iterasyon-17D1-Zamanlama-Audit-Gecis-Kaniti.md) - `TechnicallyVerified`
- [İterasyon 17D2 - Skorlama Audit Geçiş Kanıtı](Audit/Iterasyon-17D2-Skorlama-Audit-Gecis-Kaniti.md) - `TechnicallyVerified`
- [İterasyon 17E - Tarihsel Audit Aktarım Kanıtı](Audit/Iterasyon-17E-Tarihsel-Audit-Aktarim-Kaniti.md) - `TechnicallyVerified`
- [İterasyon 18A - Sınıflandırma ve Profil Minimizasyonu Kanıtı](Veri-Koruma/Iterasyon-18A-Siniflandirma-ve-Profil-Minimizasyonu-Kaniti.md) - `TechnicallyVerified`
- [İterasyon 18B - İşleme Envanteri Kanıtı](Veri-Koruma/Iterasyon-18B-Isleme-Envanteri-Kaniti.md) - `TechnicallyVerified`
- [İterasyon 18C - Envanter Tamlık Kanıtı](Veri-Koruma/Iterasyon-18C-Envanter-Tamlik-Kaniti.md) - `TechnicallyVerified`
- [İterasyon 19A - Kural Maker-Checker Kanıtı](Guvenlik-Testleri/Iterasyon-19A-Kural-Maker-Checker-Kaniti.md) - `TechnicallyVerified`
- [İterasyon 19B - Skorlama Maker-Checker Kanıtı](Guvenlik-Testleri/Iterasyon-19B-Skorlama-Maker-Checker-Kaniti.md) - `TechnicallyVerified`
...
- [İterasyon 19G - Bağlantı Revizyonu ve Onay Geçersizleştirme Kanıtı](Guvenlik-Testleri/Iterasyon-19G-Baglanti-Revizyonu-Onay-Gecersizlestirme-Kaniti.md) - `TechnicallyVerified`
- [İterasyon 19H - Kontrollü Kaynak Pasifleştirme Kanıtı](Guvenlik-Testleri/Iterasyon-19H-Kontrollu-Kaynak-Pasiflestirme-Kaniti.md) - `TechnicallyVerified`
...
- [İterasyon 22D - Veri Minimum Issue Çözüm Kanıtı](Sorun-Yonetimi/Iterasyon-22D-Veri-Minimum-Issue-Cozum-Kaniti.md) - `TechnicallyVerified`
- [İterasyon 22E - Başarısız Doğrulama Geri Dönüş Kanıtı](Sorun-Yonetimi/Iterasyon-22E-Basarisiz-Dogrulama-Geri-Donus-Kaniti.md) - `TechnicallyVerified`
- [İterasyon 22F - Başarılı Doğrulama Kanıtı](Sorun-Yonetimi/Iterasyon-22F-Basarili-Dogrulama-Kaniti.md) - `TechnicallyVerified`
- [İterasyon 22G - Kontrollü Issue Kapatma Kanıtı](Sorun-Yonetimi/Iterasyon-22G-Kontrollu-Issue-Kapatma-Kaniti.md) - `TechnicallyVerified`
- [İterasyon 22H - Aynı Kalite Başarısızlığında Yeniden Açma Kanıtı](Sorun-Yonetimi/Iterasyon-22H-Ayni-Kalite-Basarisizliginda-Yeniden-Acma-Kaniti.md) - `TechnicallyVerified`
- [İterasyon 22I - Yeni Kalite Başarısızlığı İlişkisi Kanıtı](Sorun-Yonetimi/Iterasyon-22I-Yeni-Kalite-Basarisizligi-Iliskisi-Kaniti.md) - `TechnicallyVerified`
- [İterasyon 23A - ServiceNow Veri Minimum Ticket Kanıtı](Sorun-Yonetimi/Iterasyon-23A-ServiceNow-Veri-Minimum-Ticket-Kaniti.md) - `TechnicallyVerified`
- [İterasyon 23B - ServiceNow Retry Backoff Kanıtı](Sorun-Yonetimi/Iterasyon-23B-ServiceNow-Retry-Backoff-Kaniti.md) - `TechnicallyVerified`
- [İterasyon 23C - ServiceNow Kalıcı Retry Kuyruğu Kanıtı](Sorun-Yonetimi/Iterasyon-23C-ServiceNow-Kalici-Retry-Kuyrugu-Kaniti.md) - `TechnicallyVerified`
- [İterasyon 23D - ServiceNow Circuit Breaker Kanıtı](Sorun-Yonetimi/Iterasyon-23D-ServiceNow-Circuit-Breaker-Kaniti.md) - `TechnicallyVerified`
...
- [İterasyon 25C - İdempotent İmha İşi ve Kanıt Zarfı](Veri-Koruma/Iterasyon-25C-Idempotent-Imha-Isi-Kanit-Zarfi.md) - `TechnicallyVerified`
...
- [İterasyon 28D - Bağımlılık Zafiyet Sürüm Kapısı Kanıtı](Guvenlik-Testleri/Iterasyon-28D-Bagimlilik-Zafiyet-Surum-Kapisi-Kaniti.md) - `TechnicallyVerified`
- [İterasyon 28E - Veri Minimum Sızma Testi Bulgu Takip Kanıtı](Guvenlik-Testleri/Iterasyon-28E-Veri-Minimum-Pentest-Bulgu-Takip-Kaniti.md) - `TechnicallyVerified`
