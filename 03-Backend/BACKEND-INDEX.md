...
| Profilleme | [Metadata ve Profilleme](../01-SRS/04-Fonksiyonel-Gereksinimler/04.03-Metadata-ve-Profilleme.md) | `veri_kalitesi/data_sources`, `veri_kalitesi/profiling` | Temel null/distinct/min/max/ortalama ve duplicate runtime'ı mevcut; top-N/dağılım, aykırı değer, kolon ilişkisi ve drift genel runtime'ı ile üretim bağlayıcıları açıktır. |
