...
| Kalıcı iş kuyruğu | [Çalıştırma ve Zamanlama](../01-SRS/04-Fonksiyonel-Gereksinimler/04.05-Calistirma-ve-Zamanlama.md), [Güvenilirlik](../01-SRS/09-Fonksiyonel-Olmayan-Gereksinimler/09.04-Guvenilirlik-ve-Hata-Toleransi.md) | `veri_kalitesi/jobs` | 36H1 kuyruk/lease/concurrency çekirdeği teknik olarak doğrulandı. 36H2 execution/report atomik enqueue, handler heartbeat, reaper, ayrı deadline/sürücü iptali, bounded total-timeout, retry, zorunlu terminal audit/outbox ve dead-letter kod yüzeyi ile hedefli birim kanıtına sahiptir; controller/reviewer kapıları beklenmektedir. |
