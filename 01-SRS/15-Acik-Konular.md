...
Bu bölüm yalnız karar bekleyen kayıtları görünür kılar. Hedef tarihler proje planı
olmadığı için TBD bırakılmıştır. `OPEN-001`–`OPEN-018` kararları kesinleşmiş ve
...
| OPEN-024 | Sentetik veri için dağılım/korelasyon/görev faydası/gizlilik eşikleri, `LOW/MEDIUM/HIGH/CRITICAL` kusur yoğunluklarının sayısal karşılıkları, beklenen skor toleransı ve izinli üretim yöntemleri | DecisionRequired | Veri Yönetişimi / Risk Yönetimi / Bilgi Güvenliği / Yazılım Mimari | TBD | FR-090–FR-095, NFR-PERF-010, NFR-PRV-007, AC-050–AC-053; ADR-016 |
| OPEN-025 | Sentetik üreticinin onaylı üretim profili veya örneğinden öğrenip öğrenemeyeceği; kullanılacaksa erişim/ortam ayrımı, veri minimizasyonu, saklama, yeniden tanımlama değerlendirmesi ve hukuki/güvenlik onayı | ComplianceReviewRequired / LegalReviewRequired / SecurityReviewRequired | Veri Sahibi / Hukuk / KVKK / Bilgi Güvenliği / Veri Yönetişimi | TBD | FR-095, NFR-PRV-007, AC-053, ADR-016; OPEN-014, OPEN-BNK-007/008/012 |

## DQ-SCR Kararlarının Bankacılık Karar ve İnceleme Kayıtlarıyla İlişkisi

`DQ-SCR` kararlarının kabulü, teknik yönü seçilmiş `ProvisionalDecision`
kayıtlarının kalan banka onayını veya gerçek açık/inceleme kayıtlarını otomatik
