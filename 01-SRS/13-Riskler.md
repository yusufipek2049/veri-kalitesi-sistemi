...
| RISK-014 | Kayıt sınıfı bazlı saklama matrisinin depolama ve sorgu maliyetini artırması | Orta | Orta | Orta | Bölümleme, arşiv katmanı, özet tablolar, kapasite tahmini | Politika süresi dolmayan ayrıntıyı arşive taşı; çevrimiçi özetleri koru | Sistem Yöneticisi / DBA |
| RISK-015 | Kurumsal IdP/SSO veya LDAP arka ucundaki kesintinin kullanıcı erişimini durdurması | Düşük-Orta | Yüksek | Yüksek | IdP HA, timeout, sağlık kontrolü, fail-closed erişim ve güvenlik onaylı break-glass prosedürü | IAM eskalasyonu; yalnız kontrollü/süreli/auditli break-glass; kritik işlemleri kısıtlama | Kimlik Yönetimi Ekibi |
| RISK-016 | Sentetik verinin gerçek kaydı ezberlemesi, aşırı benzemesi veya nadir kombinasyonlarla yeniden tanımlamaya izin vermesi | Orta | Çok Yüksek | Kritik | Üretim erişim ayrımı, veri minimizasyonu, sürümlü gizlilik profili, benzerlik/çıkarım testleri ve fail-closed kullanım kapısı | Dataseti `BLOCKED` yap; erişimi kes; çıktıyı imha et; gizlilik olay sürecini değerlendir; profil/yöntemi onayla | Bilgi Güvenliği / KVKK / Veri Sahibi |
| RISK-017 | Ground truth'un runtime kural/skor motorundan türetilmesi veya sentetik senaryonun görev faydasının düşük olması nedeniyle hatalı motorun kendini doğrulaması | Orta | Yüksek | Yüksek | Bağımsız oracle, sürümlü senaryo/seed, geçerli uç ve kusur ayrımı, false positive/negative ve skor sapması testi | Kabulü durdur; ground truth'u bağımsız incele; senaryo ve doğrulama politikasını yeni sürümle düzelt | Veri Kalitesi Uzmanı / Veri Yönetişimi / Yazılım Mimari |
| RISK-018 | Korelasyonun doğrulanmış neden gibi sunulması veya kanıtsız önerinin karar sürecini yönlendirmesi | Orta | Çok Yüksek | Kritik | Kanıt bağı, nedensellik sınıfı, ayrı teşhis/öneri güveni ve fail-closed yayımlama kapısı | Öneriyi geri çek; etkilenen kararları işaretle; bağımsız inceleme ve yeni sürüm üret | Veri Yönetişimi / Risk Yönetimi / Model Risk Yönetimi |
| RISK-019 | Remediation veya chaos eyleminin yetkisiz ortamda üretim verisini ya da hizmetini etkilemesi | Düşük-Orta | Çok Yüksek | Kritik | `SuggestOnly` güvenli varsayılanı, ortam izolasyonu, görevler ayrılığı, dry-run, canary, stop koşulu ve rollback | Eylemi durdur; geri al; güvenlik olayı akışını başlat; politika ve yetkileri iptal et | Bilgi Güvenliği / Operasyon / İç Kontrol |
| RISK-020 | Kanıt öğesi, sorgu veya kayıt örneğinde müşteri sırrı ya da kişisel veri açığa çıkması | Orta | Çok Yüksek | Kritik | Sınıflandırma, maskeleme, fingerprint/tokenizasyon, geçici yetki, gerekçe ve indirme kısıtı | Erişimi kes; kanıtı karantinaya al; ihlal değerlendirmesi ve kontrollü imha uygula | Bilgi Güvenliği / KVKK / Veri Sahibi |
| RISK-021 | Eksik veya eski lineage nedeniyle etki alanının ve düzeltme yayılımının yanlış hesaplanması | Orta | Yüksek | Yüksek | Sürümlü snapshot, kaynak/güncellik göstergesi, eksik kapsama uyarısı ve simülasyon engeli | Etki sonucunu geçersiz kıl; lineage'ı yenile; simülasyonu yeniden çalıştır | Veri Mimarisi / Veri Yönetişimi |
| RISK-022 | Manifest, motor veya politika sürümü eksikliği nedeniyle sonucun yeniden üretilememesi | Orta | Yüksek | Yüksek | Değişmez run manifesti, hash, snapshot/partition, seed ve tüm sürüm referansları | Sonucu resmî karardan çıkar; eksikliği kaydet; uygun snapshot ile kontrollü replay yap | Operasyon / Veri Kalitesi Uzmanı |
