...
| BR-011 | Politika kontrollü iyileştirme ve kontrol yeterliliği | Öneri, remediation, data contract, adaptif tarama ve chaos deneyi yetki/politika/onay/rollback sınırında yönetilmelidir. | İyileştirmenin yeni veri, operasyon ve güvenlik riski üretmesini önlemek | Veri Yönetişimi / Bilgi Güvenliği / Operasyon | Could — ikinci faz | Üretim verisine yazma olmaması; onaysız otomasyon ve izole olmayan chaos deneylerinin %100 reddedilmesi. | FR-105–FR-110; OPEN-030–OPEN-035 |
