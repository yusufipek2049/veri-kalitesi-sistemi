...
| Kanıta dayalı kullanım kararı, etki, lineage, öneri, remediation ve chaos | [04.14-Kanita-Dayali-Karar-Destegi](04-Fonksiyonel-Gereksinimler/04.14-Kanita-Dayali-Karar-Destegi.md), [UC-018–UC-021](05-Kullanim-Senaryolari/INDEX.md), [Kanonik Karar Sistemi](../02-Mimari/Kanita-Dayali-Karar-Sistemi.md), [Kanıt ve Karar Desteği Varlıkları](07-Veri-Modeli/Kanit-ve-Karar-Destegi-Varliklari.md), [OPEN-026–OPEN-036 karar kaydı](../00-Proje-Hafizasi/Karar-Kayitlari/Skorlama-Sentetik-Veri-ve-Ikinci-Faz-Kararlari.md) |
| Ürün yetenek listesi kapsam/durum incelemesi | [Ürün Yetenek Durum Matrisi](../00-Proje-Hafizasi/Urun-Yetenek-Durum-Matrisi.md), [DQ-CAP-001–015 prototip kararları](../00-Proje-Hafizasi/Karar-Kayitlari/Urun-Yetenekleri-Prototip-Kararlari.md) |
