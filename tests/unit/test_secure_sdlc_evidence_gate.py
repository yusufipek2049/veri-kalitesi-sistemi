...
MANIFEST_PATH = "docs/compliance/Surum-Paketleri/synthetic-manifest.json"
...
@pytest.mark.parametrize(
    ...
    (
        "/tmp/manifest.json",
        "docs/compliance/Surum-Paketleri/../manifest.json",
        "docs/compliance/Surum-Paketleri\\manifest.json",
        "docs/compliance/Erisim/manifest.json",
        "docs/compliance/Surum-Paketleri/manifest.md",
        "docs/compliance/Surum-Paketleri//manifest.json",
    ),
)
