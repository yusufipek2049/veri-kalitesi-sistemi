...
EVIDENCE_A = "docs/compliance/Erisim/synthetic-evidence.md"
...
@pytest.mark.parametrize(
    ...
    (
        ...
        "docs/compliance\\Erisim\\evidence.md",
        "README.md",
        "docs/compliance/Erisim/evidence.txt",
        "docs/compliance//Erisim/evidence.md",
    ),
)
...
def test_rejects_missing_directory_and_symlink_evidence(tmp_path: Path) -> None:
    ...
    target = _write_evidence(tmp_path, "docs/compliance/Erisim/target.md", b"target")
