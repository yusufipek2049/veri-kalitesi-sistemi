...
EVIDENCE_PATH = "docs/compliance/Erisim/synthetic-evidence.md"
SBOM_PATH = "docs/compliance/Surum-Paketleri/Iterasyon-28B-SBOM.cdx.json"
CATALOG_PATH = "docs/compliance/Surum-Paketleri/Iterasyon-29A-Teknik-Kanit-Katalogu.json"
MANIFEST_PATH = "docs/compliance/Surum-Paketleri/Iterasyon-29A-Teknik-Kanit-Manifesti.json"
...
def test_success_output_is_deterministic_and_data_minimum(tmp_path: Path) -> None:
    sensitive_path = "src/sensitive/location.py"
...
def _sast_finding(
    severity: str,
    relative_path: str = "src/sample.py",
) -> dict[str, object]:
    return {
        "scanner_id": "synthetic-sast",
        "scanner_version": "1.2.3",
