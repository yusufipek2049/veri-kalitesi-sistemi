...
| 25 | Saklama dry-run (`25A`), kalıcı legal hold (`25B`) ve idempotent imha işi/kanıt zarfı (`25C`) tamamlandı; fiziksel adaptör ve arşiv geri çağırma açık | Hukuk/uyum kararı |
