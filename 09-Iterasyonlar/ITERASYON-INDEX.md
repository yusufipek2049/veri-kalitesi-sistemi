...
19. [Iterasyon-36-PostgreSQL-ve-Yazilabilir-Alan-Ekranlari](Iterasyon-36-PostgreSQL-ve-Yazilabilir-Alan-Ekranlari.md) - [36A1 PostgreSQL kalıcılık temeli](Iterasyon-36A1-PostgreSQL-Kaliclilik-Temeli.md), [36A2a issue mutasyon/audit outbox](Iterasyon-36A2a-PostgreSQL-Issue-Mutasyon-Audit.md), [36A2b seçici aktarım/SQLite kaldırma](Iterasyon-36A2b-Secici-Issue-Aktarimi.md), [36B1 atanmış sorunu incelemeye alma](Iterasyon-36B1-Sorunu-Incelemeye-Alma.md), [36B2 güvenilir yeniden atama](Iterasyon-36B2-Guvenilir-Yeniden-Atama.md) ve [36B3 korumalı çözüm kaydı](Iterasyon-36B3-Korumali-Cozum-Kaydi.md) `TechnicallyVerified`; 36B4 `Ready`
