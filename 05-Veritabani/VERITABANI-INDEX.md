...
| Çalıştırmalar | `20260724_04_execution_baseline.py`, `20260730_12_rule_ir_shadow_evidence.py` | Var | Repository/cutover'a ek olarak OFFICIAL/SHADOW, resmî downstream uygunluk kapıları ve JSON veri-minimum kanıt kalıcıdır. |
