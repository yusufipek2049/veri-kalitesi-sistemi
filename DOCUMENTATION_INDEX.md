...
| [NEXT_STEP](NEXT_STEP.md) | Son tamamlanan çalışma paketi ve sıradaki durum | DQ-CAP-PROTOTYPE-01 `PrototypeVerified`; `ComplianceReviewRequired`, production-ready değil; yeni `Next`/`READY` teknik paket yok | İterasyon, backlog, test | Aktif | Teslimat |
