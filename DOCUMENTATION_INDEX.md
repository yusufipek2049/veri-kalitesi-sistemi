...
| [NEXT_STEP](NEXT_STEP.md) | Tek sıradaki çalışma paketi | Kalıcı iş kuyruğu ve worker dayanıklılığı | Kod, migration, test | Aktif | Teslimat |
...
| [Dokümantasyon Denetimi](DOCUMENTATION_AUDIT.md) | Konsolidasyon sonucu | Taşıma, tutarlılık ve doğrulama bulguları | Tüm depo | 2026-07-24 | Dokümantasyon |
