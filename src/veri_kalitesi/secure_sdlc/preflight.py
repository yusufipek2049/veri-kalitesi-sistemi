...
_STORED_SBOM = "docs/compliance/Surum-Paketleri/Iterasyon-28B-SBOM.cdx.json"
_EVIDENCE_CATALOG = "docs/compliance/Surum-Paketleri/Iterasyon-29A-Teknik-Kanit-Katalogu.json"
_STORED_EVIDENCE_MANIFEST = (
    "docs/compliance/Surum-Paketleri/Iterasyon-29A-Teknik-Kanit-Manifesti.json"
)
