...
class GovernanceRequestType(str, Enum):
    ...
    METADATA_DIFF_APPLICATION = "METADATA_DIFF_APPLICATION"
    ...
    SCHEDULE_INTERVAL_EXCEPTION = "SCHEDULE_INTERVAL_EXCEPTION"
...
GOVERNANCE_REQUEST_DOMAINS: Mapping[GovernanceRequestType, GovernanceDomain] = MappingProxyType(
    {
        ...
        GovernanceRequestType.METADATA_DIFF_APPLICATION: (
            GovernanceDomain.METADATA_AND_CLASSIFICATION
        ),
        ...
        GovernanceRequestType.SCHEDULE_INTERVAL_EXCEPTION: GovernanceDomain.SCHEDULE,
    }
)
