...
olayı tüketir. Idempotency key, dedup/suppression penceresi ve routing sürümlü
politikadan gelir. Gerçek kanal hatası kalite sonucunu değiştirmez. Tek sabit
deneme ile teslim yapılır; retry/escalation semantiği uygulanmamıştır.
"""
...
class NotificationChannelPolicy:
    ...
    Idempotency, dedup/suppression ve routing bu politikadan çözülür.
    Politika yoksa kanal işlemi yapılmaz (fail-closed).
    """
