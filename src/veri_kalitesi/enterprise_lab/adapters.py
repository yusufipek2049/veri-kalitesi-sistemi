...
def build_enterprise_lab_application_adapters(
    ...
    *,
    ...
    # Kanit omru esigi dogrulanmis lab yapilandirmasindan gelir; ortuk
    # varsayilan kullanilmaz (ADR-018, environment.json schema_version 2).
    gate = LabAdapterGate(
        StaticLabEnvironmentProvider(_derive_lab_gate_evidence(evidence)),
        max_evidence_age_seconds=evidence.max_evidence_age_seconds,
    )
