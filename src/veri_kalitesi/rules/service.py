...
class RuleService(Generic[AuditT]):
    ...
    def create_rule(
        ...
        *,
        ...
        self._authorize_command_actor(actor_id, actor_context, dataset_id)
    ...
    def create_version(
        ...
        *,
        ...
        self._authorize_command_actor(actor_id, actor_context, rule.dataset_id)
    ...
    def _authorize_data_steward(
        ...
        *,
        ...
        if (
            ...
            and context.policy_version != self.approval_policy.actor_policy_version
        ):
    ...
    def _authorize_command_actor(
        ...
        if not self.enforce_command_authorization:
            return context
        trusted = self._authorize_data_steward(context, dataset_id=dataset_id)
        if trusted.actor_id != actor_id:
            raise RuleAuthorizationError("Rule actor_id must match the trusted actor context.")
        return trusted
