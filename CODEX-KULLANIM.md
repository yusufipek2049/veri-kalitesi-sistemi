...
Kok `AGENTS.md`, görev alanına göre ilgili modül talimatını seçmesini Codex'e söyler. En düşük bağlam tüketimi için Codex'i doğrudan modül klasöründe başlatmak da mümkündür.
...
geçiş kapısını kontrol edip güncel sıradaki hazır artımı seçmelidir. Sıradaki
iterasyon `Sonraki-Adimlar.md` dosyasında kayıtlıdır; hard-coded iterasyon
numarası yerine proje hafızası esas alınır. Daha katı komut:
