...
27. Kritik kural aktivasyonu için 19A, skor konfigürasyonu için 19B, kural onay isteği geri çekme için 19C, 3/10 iş günlük süre aşımı için 19D ve veri kaynağı aktivasyonu için 19E maker-checker akışı uygulandı. Gerçek banka iş günü/tatil kaynağı, worker işletimi, hazırlayanı bilinmeyen legacy kritik sürümlerin geçiş prosedürü, kaynak kritiklik sözlüğü, bağlantı güncellemesinde revizyon artırma, pasife alma, kaynak onay isteği geri çekme/süre aşımı ve banka onaylı maker/checker/worker rol kodları açık kalır.
