...
27. Kritik kural aktivasyonu için 19A, skor konfigürasyonu için 19B, kural onay isteği geri çekme için 19C, 3/10 iş günlük kural süre aşımı için 19D, veri kaynağı aktivasyonu için 19E, kaynak onay geri çekme/süre aşımı için 19F ve bağlantı revizyonu/onay geçersizleştirme için 19G maker-checker akışı uygulandı. Gerçek banka iş günü/tatil kaynağı, worker işletimi, hazırlayanı bilinmeyen legacy kritik sürümlerin geçiş prosedürü, kaynak kritiklik sözlüğü, üretim migration/çoklu instance eşzamanlılığı, kontrollü pasife alma ve banka onaylı maker/checker/worker rol kodları açık kalır.
