...
| 5 | Kurumsal IdP/SSO-MFA ve RBAC üretim entegrasyonu tamamlanmadı | 20A context'i dashboard authorization'a bağlar; 20B giriş sınırı, 20C temel normal session, 20D onaylı süre/tek aktif oturum alt kapsamını uygular; gerçek IdP endpoint/protokol yapılandırması, banka eşlemesi, HTTP/BFF, ayrıcalıklı/servis oturumu ve üretim altyapısı açık | Uygulama / 21B öncesi |
