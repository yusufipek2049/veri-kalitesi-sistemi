...
- Public dashboard sorguları scope kabul etmez; güvenilir context'i scope'a çeviren authorization servisini kullanır. Skor ağacı ve sabit son 30 günlük trend domain sorgusu yetki filtrelidir. 21B yerel/test FastAPI özetini ve bağlı frontend'i, 21C aynı yetki sınırında veri-minimum operasyonel göstergeleri eklemiştir; üretim resolver varsayılan olarak erişimi reddeder. Internal/deprecated geçiş adaptörü henüz kaldırılmamıştır.
