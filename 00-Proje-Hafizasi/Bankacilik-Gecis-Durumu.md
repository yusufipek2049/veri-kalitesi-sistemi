...
| PostgreSQL kalıcılık | issue, rule ve data source repository geçişleri belgeli; execution repository/migration kodu mevcut | execution production composition root cutover ve kalan domain geçişleri tamamlanmalı |
...
**Hazır değil.** Açık kayıtlar [Açık Konular](Acik-Konular.md), tek sıradaki paket [NEXT_STEP](../NEXT_STEP.md), backlog [Sonraki Adımlar](Sonraki-Adimlar.md), ayrıntılı tarihsel geçiş kaydı ise [arşiv](../docs/archive/project-memory-2026-07-24/Bankacilik-Gecis-Durumu.md) içindedir.
