...
10. İterasyon 28 — 28A secret, 28B doğrudan bağımlılık SBOM'u, 28C SAST ve 28D doğrudan bağımlılık zafiyet sürüm kapıları `TechnicallyVerified`; gerçek scanner, transitive çözüm ve sızma testi hazırlığı açık.
...
| 28 | Güvenli SDLC ve pentest hazırlığı | `NFR-SEC-*`, `BFR-SDLC-001`–`BFR-SDLC-005` | SAST, secret/dependency taraması, SBOM ve pentest kapsamı | 28A secret, 28B doğrudan bağımlılık SBOM'u, 28C SAST ve 28D bağımlılık zafiyet kapıları `TechnicallyVerified`; kalan dilimler açık |
...
**İterasyon 28E — Veri-minimum sızma testi bulgu takip sözleşmesi.**

`BFR-SDLC-003/005` üzerinden sızma testi bulgusunu önem derecesi, veri-minimum aksiyon/sorumlu referansı ve tekrar test kanıtıyla ilişkilendir. Gerçek pentest hizmeti, banka kapsamı ve sıklığı, serbest rapor içeriği, dış scanner ürünü ve banka onayını bu dilime alma.
