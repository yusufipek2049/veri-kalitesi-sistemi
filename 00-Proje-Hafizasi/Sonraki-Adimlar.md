...
10. İterasyon 28 — 28A secret, 28B doğrudan bağımlılık SBOM'u, 28C SAST, 28D doğrudan bağımlılık zafiyet sürüm kapısı ve 28E sızma testi bulgu takibi `TechnicallyVerified`; gerçek scanner, transitive çözüm ve gerçek pentest açık.
11. İterasyon 29 — 29A manifest, 29B drift kapısı ve 29C birleşik yerel preflight `TechnicallyVerified`; 29D kurumsal CI/CD/imzalı kanıt yayını engelli.
...
**Hazır ve engellenmemiş yeni ürün artımı yoktur.**

Sonraki teknik aday **İterasyon 29D — Kurumsal CI/CD entegrasyonu ve imzalı kanıt
yayınıdır**, ancak CI/CD/scanner ürünü, artifact imza/depo yaklaşımı, release
görevler ayrılığı ve banka eşik/istisna kararları tamamlanana kadar engellidir.
HTTP/frontend için `OPEN-BNK-020`, 19D için `OPEN-BNK-017` ve üretim platformu
için `OPEN-BNK-012` sonuçlanmadan yeni uygulama kapsamı açılmamalıdır.
