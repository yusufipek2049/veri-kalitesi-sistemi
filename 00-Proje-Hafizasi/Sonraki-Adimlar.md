...
Bu maddeler `ADR-016` hedef tasarımını küçük dikeylere böler; mevcut `33A`
skorlama artımının önceliğini değiştirmez.

| ID | Ürün artımı | Gereksinim | Çıkış kriteri | Durum |
| --- | --- | --- | --- | --- |
| SYN-001 | Sentetik dataset politika, senaryo ve run kayıt çekirdeği | FR-088, FR-093; AC/TS-049 | Fail-closed politika çözümleme, değişmez sürüm/seed/run kaydı ve veri-minimum audit | Planlı; teknoloji bağımsız tasarım hazır |
