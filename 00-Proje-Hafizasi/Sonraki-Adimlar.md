...
trend ve rapor önizleme entegrasyonu 32B ile tamamlandı. Kalan davranışlar;
CPU/IO ve hız sınırı gözlemi, güvenilir kısmi çalışma olgusu üretimi ve audit,
...
Önerilen sonraki artım **İterasyon 32C — Güvenilir kısmi çalışma olgusu üretimi
ve politika karar auditi**dir. Kapsama, eksik kayıt ve partition olgularının
worker/execution sınırından güvenilir ve yeniden üretilebilir biçimde üretilmesi;
kararın merkezi audit sözleşmesine veri-minimum bağlanması ele alınmalıdır.
