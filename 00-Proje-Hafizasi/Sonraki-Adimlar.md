...
5. **İterasyon 35A–35F — Alan ekranları:** Sıradaki artım 35A Veri Kaynakları;
   ardından Kurallar,
...
30C, 20E, 21C ve 30D tamamlandı. 35A–35F'nin üretim bağlantısı gerçek IdP callback,
...
içerik tamamlaması** tamamlandı. Sıradaki kullanıcı öncelikli küçük artım 35A
salt okunur Veri Kaynakları ekranı ve route kabuğudur.
...
tamamladı. Sıradaki hazır frontend artımı **İterasyon 35A — salt okunur Veri
Kaynakları ekranı ve route kabuğu**dur. Üretim bağlantısı ayrıca gerçek IdP
