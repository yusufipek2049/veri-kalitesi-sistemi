...
11. İterasyon 29 — 29A deterministik teknik kanıt manifesti ve 29B byte düzeyinde drift kapısı `TechnicallyVerified`; birleşik yerel ön kontrol, imzalama/depo ve banka kabulü açık.
...
| 29 | Banka kabul paketi | Tüm `BFR-*` ve `CTRL-*` | Teknik kanıtlar ve eksikler görünür; banka onayları ayrı durumda | 29A manifest ve 29B drift kapısı `TechnicallyVerified`; 29C birleşik yerel ön kontrol sırada, banka onayı açık |
...
**İterasyon 29C — Birleşik yerel sürüm ön kontrolü.**
...
scanner, CI/CD ürünü, elektronik imza, WORM/kurumsal kanıt deposu, istisna/risk
kabulü ve `ApprovedByBank` kararı bu dilime alınmasın.
