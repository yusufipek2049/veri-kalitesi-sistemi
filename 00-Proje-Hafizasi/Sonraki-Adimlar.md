...
`DQ-SCR-001`–`DQ-SCR-033` hedef dokümantasyon sözleşmesi kesinleşti. İlk hazır
...
`RuleResult` istisna/kapsam sayaçlarını, standart durum eşlemesini ve oran
paydasını ele almalı; risk, güven formülü, kritik veto veya UI kapsamına
genişlememelidir.
...
kapsam/güven; ayrı kritiklik/risk; istisna/override; API/UI/trend; alarm ve
remediation. Üretim eşik/ağırlık/veto/güven/risk değerleri ve banka rol matrisi
karar gerektirdiği için ilgili dilimler `OPEN-BNK-004/013` ile engellidir.
