...
5. **İterasyon 35A–35F — Alan ekranları:** 35A Veri Kaynakları
   `TechnicallyVerified`; sıradaki artım 35B Kurallar, ardından
...
30C, 20E, 21C, 30D ve 35A tamamlandı. 35B–35F'nin üretim bağlantısı gerçek IdP callback,
...
içerik tamamlaması** ile **İterasyon 35A — salt okunur Veri Kaynakları ekranı**
tamamlandı. Sıradaki kullanıcı öncelikli küçük artım 35B salt okunur Kurallar
ekranıdır.
...
tamamladı. 35A veri-minimum/scope filtreli Veri Kaynakları API'sini, route
kabuğunu ve salt okunur liste ekranını tamamladı. Sıradaki hazır frontend artımı
**İterasyon 35B — salt okunur Kurallar ekranı**dır. Üretim bağlantısı ayrıca gerçek IdP
