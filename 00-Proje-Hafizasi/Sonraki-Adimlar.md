...
Mevcut 16 iterasyonun, Iterasyon 17A–17E audit, Iterasyon 18A–18C veri koruma, Iterasyon 19A–19H maker-checker, Iterasyon 20A–20C LDAP/oturum güvenliği ve Iterasyon 25A–25C saklama/legal hold/imha kanıtı dikeylerinin çekirdeği korunur. Banka kararları tamamlanmadan yeni HTTP yüzeyi açılmaz.
...
8. İterasyon 25 — 25A saklama politikası dry-run, 25B kalıcı legal hold ve 25C idempotent imha işi/kanıt zarfı `TechnicallyVerified`; fiziksel adaptör ve arşiv geri çağırma açık.
...
| 25 | Saklama/imha/legal hold | `RULE-014`, `BFR-LCM-001`–`BFR-LCM-004` | Kayıt türü bazlı politika; imha ve geri çağırma kanıtı | 25A–25C `TechnicallyVerified`; fiziksel adaptör, gerçek resolver'lar ve geri çağırma açık; banka onayı bekleniyor |
...
Sonraki teknik aday **İterasyon 25D — Yetkili arşiv geri çağırma talebi ve
veri-minimum audit sözleşmesi** dilimidir. Kapsam yalnız opak arşiv referansı,
gerekçe, güvenilir rol/kapsam, farklı karar aktörü ve append-only talep/karar
kanıtıyla sınırlandırılmalı; gerçek arşiv okuma/taşıma adaptörü banka onayı olmadan
etkinleştirilmemelidir. Fiziksel imha adaptörü `OPEN-BNK-008`, 29D
`OPEN-BNK-012`, 21B/frontend `OPEN-BNK-020`, hassas dışa aktarma
