...
| FE-DASH-001 | Ölçüm yeterliliği, kritik kontrol ve teknik hata KPI sözleşmesi ile API bağlantısı | Must | Yeterlilik runtime'ı, dashboard API | `FE-DEC-004` KararAlındı; runtime/API bağımlılığı var |
