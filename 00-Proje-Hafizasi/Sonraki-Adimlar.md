...
11. İterasyon 29 — 29A deterministik teknik kanıt manifesti ve eksik kontrol raporu `TechnicallyVerified`; drift kapısı, imzalama/depo ve banka kabulü açık.
...
| 29 | Banka kabul paketi | Tüm `BFR-*` ve `CTRL-*` | Teknik kanıtlar ve eksikler görünür; banka onayları ayrı durumda | 29A manifest `TechnicallyVerified`; 29B drift kapısı sırada, banka onayı açık |
...
**İterasyon 29B — Teknik kanıt manifesti drift doğrulama kapısı.**

Sürümde saklanan manifesti katalog ve kanıt artifact'larından yeniden üretip byte
düzeyinde karşılaştıran fail-closed doğrulama komutu ekle. CI/CD ürünü, elektronik
imza, WORM/kurumsal kanıt deposu, istisna/risk kabulü ve `ApprovedByBank` kararı bu
dilime alınmasın.
