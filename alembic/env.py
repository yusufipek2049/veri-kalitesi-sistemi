...
from veri_kalitesi.persistence import DatabaseSettings, SCHEMA_ENV
...
def _settings() -> DatabaseSettings:
    ...
    configured_schema = config.get_main_option("data_quality_schema", "").strip()
    schema = configured_schema or os.environ.get(SCHEMA_ENV, "dq")
